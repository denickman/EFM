...
final class LoadFeedImageDataFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        ...
        XCTAssertNil(receivedResults, "Expected nil results after sut has been deallocated")
    }
    ...
    private func expect(
        ...
        _ = sut.loadImageData(from: url) { receivedResult in
            ...
            case let (.success(expData), .success(recData)):
                XCTAssertEqual(expData, recData, file: file, line: line)
                
            case let (.failure(expError as RemoteFeedImageDataLoader.Error),
                      .failure(recError as RemoteFeedImageDataLoader.Error)):
                XCTAssertEqual(expError, recError, file: file, line: line)
