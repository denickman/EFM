...
extension FeedSnapshotTests {
    ...
    private func assert(snapshot: UIImage, named name: String, file: StaticString = #filePath, line: UInt = #line) {
        ...
        if snapshotData != storedSnapshotData {
            ...
            XCTFail("New snapshot does not match stored snapshot. \nNew snapshot URL: \(temporarySnapshotURL), \nstored snapshot URL: \(snapshotURL)", file: file, line: line)
        }
    }
}
...
extension FeedSnapshotTests {
    ...
    private func makeSnapshotURL(named name: String, file: StaticString) -> URL {
        // /Users/denisyaremenko/Desktop/iOS/Education/2025/Caio & Mike/EF Manually/EFM/EFM/EFMiOSTests/FeedSnapshotTests.swift
        // /Users/denisyaremenko/Desktop/iOS/Education/2025/Caio & Mike/EF Manually/EFM/EFM/EFMiOSTests/
        // /Users/denisyaremenko/Desktop/iOS/Education/2025/Caio & Mike/EF Manually/EFM/EFM/EFMiOSTests/snapshots
        
        /// // ../EFMiOS/snapshots/name.png
    ...
    private func makeSnapshotData(for snapshot: UIImage, file: StaticString, line: UInt) -> Data? {
        guard let data = snapshot.pngData() else {
            XCTFail("Failed to generate png data representation from snaphot", file: file, line: line)
            return nil
        }
        return data
    }
